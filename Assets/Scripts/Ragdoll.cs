...
public class Ragdoll : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (hipsRb.linearVelocity.magnitude < 0.1) ragdoll();// if it is knocked down and not moving
            else if (hipsRb.linearVelocity.magnitude < 1) StartCoroutine(setConscious(3)); // if it is knocked down but moving too much to get up
        }
    }
